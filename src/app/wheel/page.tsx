...
import { setMuted as setSoundMuted } from "@/lib/wheel-sound";
  ...
  return (
    <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center px-4 py-8">
      ...
      <div className="relative w-full overflow-hidden rounded-3xl border border-app-light-stroke bg-gradient-to-b from-[#0d0930] to-app-dark-100 px-5 py-8">
        ...
        {/* mute toggle, panel top-left like the reference */}
        <button
          onClick={toggleMute}
          aria-label={muted ? "Unmute" : "Mute"}
          className="absolute left-4 top-4 z-10 grid h-9 w-9 place-items-center rounded-full bg-app-dark-200/70 text-app-secondary-text transition-colors hover:text-app-main-text"
        >
